	...
	var SuggestionList = function (_React$Component) {
	    ...
	    _createClass(SuggestionList, [{
	        ...
	        value: function handleSuggestionsChanged() {
	            ...
	            this.setState({
	                items: this.props.currentSuggestion.items, //SuggestionStore.getItems(this.props.suggestionId),
	                terms: this.props.currentSuggestion.terms, //SuggestionStore.getTerms(this.props.suggestionId),
	                components: this.props.currentSuggestion.components, // SuggestionStore.getComponents(this.props.suggestionId),
	                selection: selection
	            });
...
//# sourceMappingURL=0.7f21e649ba7bc56d1074.hot-update.js.map