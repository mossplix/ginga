...
/***/ function(module, exports, __webpack_require__) {
	...
	function highlightCurrentMentions(text, tokens) {
	    ...
	    for (var _i = 0; _i < _arr.length; _i++) {
	        var mention = _arr[_i]; // UserStore.getCurrentMentionKeys()) {
	...
	function autolinkHashtags(text, tokens) {
	    ...
	    try {
	        for (var _iterator3 = tokens[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	            ...
	            var alias = _step3$value[0];
	            var token = _step3$value[1];
	    ...
	    try {
	        for (var _iterator4 = newTokens[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
	            var newToken = _step4.value;
	        ...
	        for (var _iterator5 = terms[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
	            ...
	            try {
	                for (var _iterator6 = tokens[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
	                    ...
	                    var alias = _step6$value[0];
	                    var token = _step6$value[1];
	            ...
	            try {
	                for (var _iterator7 = newTokens[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
	                    var newToken = _step7.value;
...
//# sourceMappingURL=0.eb1d94fb615c9b2663b2.hot-update.js.map