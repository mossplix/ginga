	...
	var SuggestionList = function (_React$Component) {
	    ...
	    _createClass(SuggestionList, [{
	        ...
	        value: function handleSuggestionsChanged() {
	            ...
	            var selection = this.props.suggestion.selection; // SuggestionStore.getSelection(this.props.suggestionId);
	
	            this.setState({
	                items: this.props.suggestion.items, //SuggestionStore.getItems(this.props.suggestionId),
	                terms: this.props.suggestion.terms, //SuggestionStore.getTerms(this.props.suggestionId),
	                components: this.props.suggestion.components, // SuggestionStore.getComponents(this.props.suggestionId),
	                selection: selection
	            });
...
//# sourceMappingURL=0.860bdd23287722debdaa.hot-update.js.map