...
/***/ function(module, exports, __webpack_require__) {
	...
	var SuggestionList = function (_React$Component) {
	    ...
	    _createClass(SuggestionList, [{
	        ...
	        value: function componentWillMount() {
	            this.handleSuggestionsChanged(this.props);
	        }
	    }, {
	        key: 'componentWillUpdate',
	        value: function componentWillUpdate(nextProps, nextState) {
	            this.handleSuggestionsChanged(nextProps);
	        }
	    }, {
	        ...
	        value: function handleSuggestionsChanged(props) {
	            var _this2 = this;
	
	            var selection = props.suggestion.selection || ""; // SuggestionStore.getSelection(this.props.suggestionId);
	
	            this.setState({
	                items: props.suggestion.items || [], //SuggestionStore.getItems(this.props.suggestionId),
	                terms: props.suggestion.terms || [], //SuggestionStore.getTerms(this.props.suggestionId),
	                components: props.suggestion.components || [], // SuggestionStore.getComponents(this.props.suggestionId),
	                selection: selection
	            });
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(SuggestionList);

/***/ }

})
//# sourceMappingURL=0.f76429af742dd3c36bcb.hot-update.js.map