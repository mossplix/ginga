...
/***/ function(module, exports, __webpack_require__) {
	...
	function loadRooms() {
	    return function (dispatch, getState) {
	        httpGet('/api/v1/rooms').then(function (data) {
	            dispatch({
	    ...
	    return function (dispatch, getState) {
	        ...
	        client.searchHistory({
	            ...
	            var messages = items.map(function (x) {
	                return (0, _simpleAssign2.default)({}, x.forwarded.message, { id: x.id, from: x.forwarded.message.from.bare, to: x.forwarded.message.to.bare });
	            });
...
//# sourceMappingURL=0.337b11797eb6bf14d39f.hot-update.js.map