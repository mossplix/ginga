...
/***/ function(module, exports, __webpack_require__) {
	...
	var _radium = __webpack_require__(926);
	
	var _radium2 = _interopRequireDefault(_radium);
	
	var _reactTitleComponent = __webpack_require__(986);
	
	var _reactTitleComponent2 = _interopRequireDefault(_reactTitleComponent);
	
	var _ClearFix = __webpack_require__(987);
	
	var _ClearFix2 = _interopRequireDefault(_ClearFix);
	
	var _AppBar = __webpack_require__(1007);
	
	var _AppBar2 = _interopRequireDefault(_AppBar);
	
	var _IconButton = __webpack_require__(1009);
	
	var _IconButton2 = _interopRequireDefault(_IconButton);
	
	var _FlatButton = __webpack_require__(1094);
	
	var _FlatButton2 = _interopRequireDefault(_FlatButton);
	
	var _spacing = __webpack_require__(1000);
	
	var _spacing2 = _interopRequireDefault(_spacing);
	
	var _styleResizable = __webpack_require__(1097);
	
	var _styleResizable2 = _interopRequireDefault(_styleResizable);
	
	var _getMuiTheme2 = __webpack_require__(989);
	
	var _getMuiTheme3 = _interopRequireDefault(_getMuiTheme2);
	
	var _colorManipulator = __webpack_require__(996);
	
	var _colorManipulator2 = _interopRequireDefault(_colorManipulator);
	
	var _close = __webpack_require__(1098);
	
	var _close2 = _interopRequireDefault(_close);
	
	var _IconMenu = __webpack_require__(1099);
	
	var _IconMenu2 = _interopRequireDefault(_IconMenu);
	
	var _moreVert = __webpack_require__(1120);
	
	var _moreVert2 = _interopRequireDefault(_moreVert);
	
	var _MenuItem = __webpack_require__(1121);
	
	var _MenuItem2 = _interopRequireDefault(_MenuItem);
	
	var _PureRender = __webpack_require__(1122);
	
	var _PureRender2 = _interopRequireDefault(_PureRender);
	
	var _reactRouterRedux = __webpack_require__(246);
	
	var _colors = __webpack_require__(999);
	
	var _AppNavDrawer = __webpack_require__(1124);
	
	var _AppNavDrawer2 = _interopRequireDefault(_AppNavDrawer);
	
	var _MuiThemeProvider = __webpack_require__(1136);
	...
	var _Spinner = __webpack_require__(1139);
	
	var _Spinner2 = _interopRequireDefault(_Spinner);
	
	var _redux = __webpack_require__(226);
	
	var _selectors = __webpack_require__(1144);
	...
	var stateToProps = (0, _reactRedux.connect)(function (state) {
	  return {
	    currentUser: state.session.currentUser,
	    socket: state.session.socket,
	    channel: state.session.channel,
	...
	exports.default = stateToProps(Master);

/***/ }

})
//# sourceMappingURL=0.e1567df596c281b56b2f.hot-update.js.map