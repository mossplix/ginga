defmodule Ginga.Board do
  use Ginga.Web, :model

  alias __MODULE__
  alias Ginga.{Repo, Permalink, List, Comment, Card, UserBoard, User}
...
defimpl Poison.Encoder, for: Ginga.Board do
  def encode(model, options) do
    model
    |> Map.take([:name, :lists, :user, :members])
    |> Map.put(:id, Ginga.Board.slug_id(model))
