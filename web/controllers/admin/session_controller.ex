defmodule Ginga.Admin.SessionController do
  @moduledoc """
  ...
  # We've aliased Guardian.Plug.EnsureAuthenticated in our Ginga.Web.admin_controller macro
