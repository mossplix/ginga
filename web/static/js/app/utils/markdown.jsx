// Copyright (c) 2015 Ginga, Inc. All Rights Reserved.
...
class GingaInlineLexer extends marked.InlineLexer {
...
class GingaParser extends marked.Parser {
    parse(src) {
        this.inline = new GingaInlineLexer(src.links, this.options, this.renderer);
...
class GingaMarkdownRenderer extends marked.Renderer {
...
class GingaLexer extends marked.Lexer {
...
export function format(text, options) {
    const markdownOptions = {
        renderer: new GingaMarkdownRenderer(null, options),
        sanitize: true,
        gfm: true,
        tables: true
    };

    const tokens = new GingaLexer(markdownOptions).lex(text);

    return new GingaParser(markdownOptions).parse(tokens);
}
