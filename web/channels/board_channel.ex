defmodule Ginga.BoardChannel do
  @moduledoc """
  Board channel
  """

  use Ginga.Web, :channel

  alias Ginga.{User, Board, UserBoard, List, Card, Comment, CardMember}
  alias Ginga.BoardChannel.Monitor
    ...
    try do
      ...
      case Repo.insert(changeset) do
        {:ok, _board_user} ->
          ...
          Ginga.Endpoint.broadcast_from! self(), "users:#{user.id}", "boards:add", %{board: board}
